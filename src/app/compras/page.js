...
function buildRequestsExportRows(requests) {
    return requests.flatMap((request) => {
        const baseRow = {
            ...
            Direccion: request.service_address || 'Sin dirección cargada',
            Notas: request.notas || '',
        };
        ...
        <MainLayout>
            <div className="card" style={{ padding: 0 }}>
                <div className="page-header" style={{ padding: '1.5rem', borderBottom: '1px solid var(--border-color)' }}>
                    <div>
                        <h1>Compras</h1>
                        <p style={{ color: 'var(--text-muted)' }}>Recepción y seguimiento de pedidos de insumos enviados por supervisores</p>
                    </div>
                    <div className="page-header-actions">
                        <button type="button" className="btn btn-secondary" onClick={clearFilters}>
                            Limpiar filtros
                        </button>
                        <button type="button" className="btn btn-primary" onClick={() => exportRequests(requests, 'Pedidos_filtrados')}>
                            Descargar Excel
                        </button>
                    </div>
                </div>

                <div className="card" style={{ margin: '1.5rem', marginBottom: 0 }}>
                    <div className="page-header" style={{ marginBottom: '1rem' }}>
                        <div>
                            <h3>Filtros</h3>
                            <p style={{ color: 'var(--text-muted)' }}>Podés filtrar por día, rango de fechas, servicio o supervisor.</p>
                        </div>
                ...
                {loading ? (
                    ...
                    <div className="table-container" style={{ margin: '1.5rem' }}>
